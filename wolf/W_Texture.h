...
public:
	...
	// PUBLIC TYPES
	//-------------------------------------------------------------------------
	enum Format { FMT_888, FMT_8888, FMT_565, FMT_4444, FMT_5551, FMT_Depth, FMT_RGBA16F, FMT_NUM_FORMATS };

	enum WrapMode { WM_Repeat, WM_Clamp, WM_MirroredRepeat, WM_NUM_WRAP_MODES, WM_Invalid };
